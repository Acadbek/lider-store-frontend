    ...
    <nav className="dark:bg-black bg-white">
      ...
      <div className="sticky top-0 z-50 bg-white dark:bg-black">
        <div className="container mx-auto py-4 flex items-center justify-between">
          ...
          <Button>
            Каталог <Icon icon="BurgerMenu" color="#fff" width={24} height={24} />
          </Button>
          <div className="relative">
            <Input className="shadow-none w-[600px]" placeholder="Поиск" />
          ...
          <div className="flex gap-6 items-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-xs">Сравнение</p>
            </div>
            <div className="flex flex-col items-center">
